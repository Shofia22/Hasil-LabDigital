            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('notifications.mark-all-as-read') }}" class="text-indigo-600 hover:text-indigo-900 text-sm">Mark all as read</a>
                    </div>
                    ...
                    @if($notifications->count() > 0)
                        <div class="space-y-4">
                            ...
                            <div class="border-l-4 @if($notification->read_status === 'unread') border-indigo-500 bg-blue-50 @else border-gray-300 bg-gray-50 @endif pl-4 py-3">
                                ...
                                @if($notification->read_status === 'unread')
                                <a href="{{ route('notifications.mark-as-read', $notification->id) }}" class="text-indigo-600 hover:text-indigo-900 text-sm mt-1 inline-block">Mark as read</a>
                                @endif
                            </div>
                            @endforeach
                        </div>
