        ...
        <aside class="col-span-12 md:col-span-3 lg:col-span-2 bg-white border-r border-gray-200 flex flex-col">
            <div class="px-6 py-6 flex items-center space-x-3">
                ...
                <div>
                    ...
                    <div class="text-xs text-gray-500">Lab Panel</div>
                </div>
            </div>
            <nav class="px-3 space-y-1">
                <a href="{{ route('lab.dashboard') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium {{ request()->routeIs('lab.dashboard') ? 'bg-emerald-600 text-white' : 'text-gray-700 hover:bg-gray-100' }}">
                ...
                <a href="{{ route('lab.create-lab-result') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium {{ request()->routeIs('lab.create-lab-result') ? 'bg-emerald-50 text-emerald-700' : 'text-gray-700 hover:bg-gray-100' }}">
                ...
                <a href="{{ route('lab.lab-results') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium {{ request()->routeIs('lab.lab-results') ? 'bg-emerald-50 text-emerald-700' : 'text-gray-700 hover:bg-gray-100' }}">
